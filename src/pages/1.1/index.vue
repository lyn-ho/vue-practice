    ...
    a-tabs
      ...
      a-tab-pane(key='slot' tab='插槽')
        ...
        SlotDemo
          ...
          p(slot='title') title slot2
          p(slot='item' slot-scope='props') item slot-scopt {{ props }}
      a-tab-pane(key='bigProps' tab='大属性')
        BigProps(:name='bigPropsName' :on-change='handleBigPropChange' :slot-default='getDefault()' :slot-title='getTitle()' :slot-scop-item='getItem()')
</template>
